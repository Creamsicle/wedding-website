...
async function addSpecificGuests(dryRun = false) {
    const guestsRef = (0, firestore_1.collection)(config_1.db, 'guests');
    ...
    for (const guestData of guestsToAdd) {
        ...
        if (dryRun) {
            ...
            try {
                ...
                await (0, firestore_1.setDoc)((0, firestore_1.doc)(guestsRef, guestId), guestDocument);
