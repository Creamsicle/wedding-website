...
We start walking. And running. And talking. And holding hands. Barefoot, no less, through High Park in the middle of the night. Somehow, without quite noticing, we've crossed most of Toronto! Now at Lake Ontario, Chels' master plan is fully revealed.
...
So, so, psyched that we weren't just coworkers.`,
  },
  {
    ...
    originalWidth: 1170,
    originalHeight: 1540,
    description: `<b>CV:</b> We talked about getting a place, and realized — wait, what if we buy it??!! I sat on the floor of Neil's old apartment, in SHOCK after signing the contract for the most money I've ever seen in my life. A mortgage is crazy, and it's hilarious that we can have one (together). 
